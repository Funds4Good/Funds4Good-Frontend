...
const ProgressBar = ({ progress }) => {
    return (
        <div className="w-full bg-gray-200 rounded-lg overflow-hidden">
            <div
                className="bg-[#4F46E5] text-white py-3 text-center"
    ...
    return (
        ...
        <div className="flex flex-col items-start justify-around gap-8 p-8">
            ...
            <div className="flex items-start justify-between gap-6">
                {navItems.map((item) =>
                    <button className="rounded-full px-4 py-2 text-black hover:bg-[#4F46E5] hover:text-white">{item.name}</button>
                )}
            </div>
            <div className="bg-white border border-gray-200 rounded-lg w-full shadow-md p-4 mb-4 flex flex-col justify-between">
                ...
                <Image src={postImg} alt="Post" className="w-full mb-4 rounded-lg mb-4" />
                <div className="flex  items-start gap-6 mb-6">
                    <div className="">Amount: <span className="text-[#808080]">4000</span></div>
                ...
                <div className="flex  items-start justify-between gap-6 mb-6">
                    <div className="">Raising: <span className="text-[#4F46E5]">200$</span></div>
                    <div>Amount Left: <span className="text-[#4F46E5]">200$</span></div>   
                </div>
                <div className="flex items-start gap-4 justify-around">
                <button className="border-2 border-[#D9D9D9] text-black px-6 py-3 w-1/2 h-12 rounded-md">Read More</button>
                <button className="bg-[#4F46E5] text-white px-6 py-3 w-1/2 h-[4vw] rounded-md ">Support</button>
                </div>
            </div>
        </div>
    )
